...
(function (cjs, an) {
    ...
    (lib.补间14 = function(mode,startPosition,loop,reversed) {
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_1
            this.shape = new cjs.Shape();
            this.shape.graphics.f().s("#C08973").ss(2,1,1).p("AgngnQAIgDAJAAAAYgqQAJAAAIADAhaArIgBgBQgHgGAAgKIAAgBABjAZIAAABQAAAKgIAGAhIACIABAA");
            this.shape.setTransform(0.3,-15.225);
        
            this.shape_1 = new cjs.Shape();
            this.shape_1.graphics.f().s("#E7A25D").ss(2,1,1).p("ABJAjIiQAAQAAgBAAgBQAAgSAPgMQAHgGAKgDQgBgDAAgDQAAgTANgNQALgNAQAAQARAAAMANQAMANAAATQAAADAAADQAKADAIAGQAOAMAAASQAAABAAABQALAAAHAGQAIAHAAAKAgWgJIAuAAAhiA6QAAgKAHgHQAIgGALAA");
            this.shape_1.setTransform(0.3,-18.525);
        
            this.shape_2 = new cjs.Shape();
            this.shape_2.graphics.f().s("#B2F0F9").ss(3,1,1).p("AhyisIAbgCIAmgCQBEgDBLAFQAPABAQABQALA9AKBDQAUCGgIAfQgHAggQANQgJAIgUACQgPAChQAAQhRAAgWgCQgZgCgUgQQgWgRAAgXQAAgrAKhQQANhtAWg6g");
            this.shape_2.setTransform(-0.0208,6.5304);
        
            this.shape_3 = new cjs.Shape();
            this.shape_3.graphics.f("#D1F5FB").s().p("Ah7ApIAShRQC3gCAgAEIAOBPQjJgKguAKg");
            this.shape_3.setTransform(0.15,-5.4333);
        
            this.shape_4 = new cjs.Shape();
            this.shape_4.graphics.f("#FFCC99").s().p("AhbAqQgHgGAAgKIAAgBQAAgKAHgHQAJgGALAAIABAAIAAgCQAAgRAOgMQAHgHAKgDQAIgDAJAAIAuAAQAJAAAIADQAKADAHAHQAPAMAAARIAAACIiPAAICPAAQAKAAAIAGQAIAHAAAKIAAABQAAAKgIAGQhLgEhEACIgmADg");
            this.shape_4.setTransform(0.3,-15.225);
        
            this.shape_5 = new cjs.Shape();
            this.shape_5.graphics.f("#FFFFFF").s().p("AhcDyQgZgDgUgPQgWgSAAgXQAAgrAKhRQANhrAWg7IAbgBIAmgDQBEgCBLAEIAfACQALA9AKBDQAUCGgIAfQgHAggQANQgJAIgUADQgPAChQAAQhRAAgWgCgAB+gMIgOhQQgggEi3ACIgSBSQAXgFA+AAQA9AABlAFgAAbjCIguAAQgJAAgHACIgBgFQAAgTAMgOQAMgMAQAAQAQAAAMAMQAMAOAAATIAAAFQgIgCgJAAg");
            this.shape_5.setTransform(-0.0208,0);
        ...
        p.nominalBounds = new cjs.Rectangle(-17.5,-25.3,35,51.2);
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_1
            this.shape = new cjs.Shape();
            this.shape.graphics.f().s("#F7BCC8").ss(4,1,1).p("AjXA6QAQA9BLAaQBMAaBXgYQBagYA0g8QA0g8gRg8QgQg9hLgaQhLgahYAYQhaAYg0A8Qg0A8ARA8g");
        
            this.shape_1 = new cjs.Shape();
            this.shape_1.graphics.f("#FFFFFF").s().p("Ah8CRQhKgagRg9QgQg8Azg8QA0g8BagYQBYgYBKAaQBMAaAQA9QAQA8g0A8QgzA8hZAYQgqAMgoAAQgrAAgngOgAgZhSQg6APghAmQgiAjAKAmQAJAlAwAOQAwAPA5gPQA6gPAigmQAhgkgJgkQgKglgwgPQgXgIgaAAQgbAAgdAIg");
        
            this.shape_2 = new cjs.Shape();
            this.shape_2.graphics.f("#FCE6EA").s().p("AhRBZQgwgOgKglQgJglAigkQAhglA6gQQA5gPAwAPQAwAPAJAlQAKAkghAkQgiAmg6APQgcAIgaAAQgbAAgYgIg");
            this.shape_2.setTransform(-0.1888,0.5936);
        ...
        p.nominalBounds = new cjs.Rectangle(-24,-17.8,48,35.7);
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_1
            this.shape = new cjs.Shape();
            this.shape.graphics.f().s("#F7BCC8").ss(4,1,1).p("ADYA6QgRA9hLAaQhLAahYgYQhZgYg0g8Qg0g8ARg8QAQg9BLgaQBLgaBYAYQBZAYA0A8QA0A8gQA8g");
        
            this.shape_1 = new cjs.Shape();
            this.shape_1.graphics.f("#FCE6EA").s().p("AgXBZQg6gPgigmQghgkAKgkQAJglAwgPQAwgPA5APQA6AQAhAlQAiAkgJAlQgKAlgwAOQgYAIgbAAQgaAAgcgIg");
            this.shape_1.setTransform(0.1888,0.5936);
        
            this.shape_2 = new cjs.Shape();
            this.shape_2.graphics.f("#FFFFFF").s().p("AgnCTQhZgYgzg8Qg0g8AQg8QAQg9BMgaQBKgaBYAYQBaAYA0A8QAzA8gQA8QgRA9hKAaQgnAOgrAAQgoAAgqgMgAhPhSQgwAPgKAlQgJAkAhAkQAiAmA6APQA5APAvgPQAxgOAJglQAKgmgigjQghgmg6gPQgdgIgbAAQgaAAgXAIg");
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_21
            this.shape = new cjs.Shape();
            this.shape.graphics.f("#FFFF66").s().p("AgTAUIg8gUIA8gTIATg8IAUA8IA8ATIg8AUIgUA8g");
            this.shape.setTransform(53,-84.95);
        
            this.shape_1 = new cjs.Shape();
            this.shape_1.graphics.f("#FFFF66").s().p("AgtAJIhAhSIBlAcIBShAIgcBlIBABSIhlgcIhSBAg");
            this.shape_1.setTransform(-39.45,43.7);
        
            this.shape_2 = new cjs.Shape();
            this.shape_2.graphics.f("#FFFF66").s().p("AgnAoIh4goIB4gnIAnh4IAoB4IB4AnIh4AoIgoB4g");
            this.shape_2.setTransform(-108.95,-108.95);
        
            this.shape_3 = new cjs.Shape();
            this.shape_3.graphics.f("#FFFF66").s().p("AgaAcIhTgcIBTgaIAahTIAcBTIBSAaIhSAcIgcBSg");
            this.shape_3.setTransform(-52,-120.95);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},14).to({state:[]},5).to({state:[{t:this.shape_1}]},22).to({state:[]},5).to({state:[{t:this.shape_2}]},31).to({state:[{t:this.shape_2}]},4).to({state:[]},1).to({state:[{t:this.shape_3}]},30).to({state:[{t:this.shape_3}]},4).to({state:[]},1).wait(13));
        
            // 图层_20
            this.shape_4 = new cjs.Shape();
            this.shape_4.graphics.f("#FFFF66").s().p("AgRAaIhFgJIA9ghIAJhGIAhA9IBGAKIg9AhIgKBFg");
            this.shape_4.setTransform(-58.275,28.675);
        
            this.shape_5 = new cjs.Shape();
            this.shape_5.graphics.f("#FFFF66").s().p("AgYAZIhLgZIBLgYIAYhLIAZBLIBLAYIhLAZIgZBLg");
            this.shape_5.setTransform(-87,-114.95);
        
            this.shape_6 = new cjs.Shape();
            this.shape_6.graphics.f("#FFFF66").s().p("AgJAeIhGALIAygyIgMhGIAzAxIBGgLIgyAzIAMBGg");
            this.shape_6.setTransform(-40.45,55.35);
        
            this.shape_7 = new cjs.Shape();
            this.shape_7.graphics.f("#FFFF66").s().p("AgwANIhJhTIBtAWIBThJIgXBtIBLBTIhugXIhTBKg");
            this.shape_7.setTransform(50.75,31.95);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_4}]},15).to({state:[{t:this.shape_4}]},4).to({state:[]},1).to({state:[{t:this.shape_5}]},25).to({state:[{t:this.shape_5}]},4).to({state:[]},1).to({state:[{t:this.shape_6}]},25).to({state:[{t:this.shape_6}]},4).to({state:[]},1).to({state:[{t:this.shape_7}]},30).to({state:[]},4).wait(16));
        
            // 图层_17
            this.shape_8 = new cjs.Shape();
            this.shape_8.graphics.f("#FFFF66").s().p("AgkAmIhxgmIBxgkIAkhxIAlBwIBxAlIhxAlIglBxg");
            this.shape_8.setTransform(-85,7.05);
        
            this.shape_9 = new cjs.Shape();
            this.shape_9.graphics.f("#FFFF66").s().p("AgnAoIh4goIB4gnIAnh4IAoB4IB4AnIh4AoIgoB4g");
            this.shape_9.setTransform(51,-72.95);
        
            this.shape_10 = new cjs.Shape();
            this.shape_10.graphics.f("#FFFF66").s().p("AgCAmIhPAfIAshHIgfhPIBHAtIBPggIgsBHIAfBPg");
            this.shape_10.setTransform(9.625,21.675);
        
            this.shape_11 = new cjs.Shape();
            this.shape_11.graphics.f("#FFFF66").s().p("AgkALIg9hAIBXAQIA/g8IgPBXIA8BAIhXgRIg/A9g");
            this.shape_11.setTransform(-40,23.35);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_8}]},10).to({state:[{t:this.shape_8}]},4).to({state:[]},1).to({state:[{t:this.shape_9}]},28).to({state:[{t:this.shape_9}]},3).to({state:[]},1).to({state:[{t:this.shape_10}]},25).to({state:[{t:this.shape_10}]},3).to({state:[]},1).to({state:[{t:this.shape_11}]},32).to({state:[{t:this.shape_11}]},4).to({state:[]},1).wait(17));
        
            // 头部
            this.instance = new lib.头();
            this.instance.setTransform(-6.3,18,1,1,0,0,0,27,19.4);
        
            this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:19.5,rotation:-4.7273,x:-6.35,y:18.05},32).to({regY:19.4,rotation:0,x:-6.3,y:18},35).to({rotation:5.9909,y:18.05},34).to({rotation:0,y:18},28).wait(1));
        
            // 左脚
            this.instance_1 = new lib.补间2("synched",0);
            this.instance_1.setTransform(-27.8,81.55,1,1,0,0,0,12.5,5);
        
            this.timeline.addTween(cjs.Tween.get(this.instance_1).to({rotation:14.9992,y:81.6},35).to({rotation:0,y:81.55},34).to({regX:12.4,rotation:29.9973,x:-27.85},31).to({regX:12.5,rotation:0,x:-27.8},29).wait(1));
        
            // 右脚
            this.instance_2 = new lib.补间3("synched",0);
            this.instance_2.setTransform(9.45,82,1,1,0,0,0,-11.5,5);
        
            this.timeline.addTween(cjs.Tween.get(this.instance_2).to({rotation:-14.9992,x:9.5,y:82.05},35).to({regX:-11.4,rotation:0,y:82},34).to({regX:-11.3,rotation:-29.9989,x:9.55,y:81.95},31).to({regX:-11.5,rotation:0,x:9.45,y:82},29).wait(1));
        
            // MergedLayer_5
            this.shape_12 = new cjs.Shape();
            this.shape_12.graphics.f().s("#F577B4").ss(2,1,1).p("");
            this.shape_12.setTransform(-12.025,30.8457);
        
            this.shape_13 = new cjs.Shape();
            this.shape_13.graphics.f("#FFFFFF").s().p("");
            this.shape_13.setTransform(-12.025,30.8457);
        
            this.shape_14 = new cjs.Shape();
            this.shape_14.graphics.f().s("#F7A0CA").ss(2,1,1).p("AggAiQAFgHAHgMQAMgXACgYQADgYASAvQAJAWAJAcIguAAg");
            this.shape_14.setTransform(37.55,23.1555);
        
            this.shape_15 = new cjs.Shape();
            this.shape_15.graphics.f("#F7A0CA").s().p("AgNApIgTgHQAGgHAFgMQAMgXADgYQADgYARAvQAKAWAJAcg");
            this.shape_15.setTransform(37.55,23.1555);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12}]}).wait(130));
        
            // lefthand
            this.shape_16 = new cjs.Shape();
            this.shape_16.graphics.f("#F7BCC8").s().p("");
            this.shape_16.setTransform(-12.5625,43.948);
        
            this.shape_17 = new cjs.Shape();
            this.shape_17.graphics.f("#F577B4").s().p("");
            this.shape_17.setTransform(-10.9833,30.45);
        
            this.shape_18 = new cjs.Shape();
            this.shape_18.graphics.f("#FFFFFF").s().p("");
            this.shape_18.setTransform(-12.4375,43.3888);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16}]}).wait(130));
        
            // 奶瓶
            this.instance_3 = new lib.补间5("synched",0);
            this.instance_3.setTransform(-13.4,40.6,1,1,-7.7911,0,0,-0.1,0.1);
        
            this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:7.2074,x:-11.3,y:40.65},66).to({rotation:-7.7911,x:-13.4,y:40.6},63).wait(1));
        
            // 图层_4
            this.shape_19 = new cjs.Shape();
            this.shape_19.graphics.f("#44B5F9").s().p("");
            this.shape_19.setTransform(-13.1179,58.3792);
        
            this.timeline.addTween(cjs.Tween.get(this.shape_19).wait(130));
        
            // 图层_10
            this.shape_20 = new cjs.Shape();
            this.shape_20.graphics.f("#54BBF9").s().p("AmiAwQg8hRAIgyQAIgyB1AUQBXAQAwAYQAZANDcgBQDqgBA8gXQA4gVAxgHQAZgEANABIjBDlQgTgKgXgKQgtgUgXAAQgZAKgoAKQhOAThGgCQhGgChZgUQgsgJgegJIgWAWQgcAYgeAEQgfgfgegpg");
            this.shape_20.setTransform(-8.5471,56.379);
        
            this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(130));
        
            // 裤子底图
            this.shape_21 = new cjs.Shape();
            this.shape_21.graphics.f().s("#44B5F9").ss(4,1,1).p("AkPl7IgbC3Ig/gIQhEgKgTgIIgQDOIgcgBQgiAJgfAyQgXAmgKA+QgPBZApA3QAqA5BOAaIBGAOQAFgaASgfQAlg+BCgVQAdAMArAMQBWAYBJAAQBIAABNgdQAngOAYgPIAVADQAbAFAZAKQBQAjAhBUQAmgHAsgTQBXgkAcg6QAYgzgJg8QgIg2gegsQgXgigngLIgjgFIgRjtQiMAXgeAEIgaijIgsADIgDCnQgcAGhDAEQiFAJjGgGIAEi3g");
            this.shape_21.setTransform(-10.1167,43.025);
        
            this.shape_22 = new cjs.Shape();
            this.shape_22.graphics.f("#57CDFF").s().p("Am8FxQhOgagqg5Qgpg3APhZQAKg+AXgmQAfgyAigJIAcABIAQjOQATAIBEAKIA/AIIAbi3IAvgDIgEC3QDGAGCFgJQBDgEAcgGIADinIAsgDIAaCjQAegECMgXIARDtIAjAFQAnALAXAiQAeAsAIA2QAJA8gYAzQgcA6hXAkQgsATgmAHQghhUhQgjQgZgKgbgFIgVgDQgYAPgnAOQhNAdhIAAQhJAAhWgYQgrgMgdgMQhCAVglA+QgSAfgFAag");
            this.shape_22.setTransform(-10.1167,43.025);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21}]}).wait(130));
        
            // 图层_5
            this.shape_23 = new cjs.Shape();
            this.shape_23.graphics.f().s("#F577B4").ss(4,1,1).p("AnHC9IhJANQhPAMgmgEQAJgxAghDQA/iFBvhbQBuhcC1AMQBbAGBDAYQA1gUBLgDQCVgHBqBTQBsBUBJByQAeAuAhBKIinAVImGglg");
            this.shape_23.setTransform(-11.85,10.4608);
        
            this.shape_24 = new cjs.Shape();
            this.shape_24.graphics.f("#F7A0CA").s().p("ABZCvIogAOIhJANQhPAMgmgEQAJgxAhhDQA+iFBvhbQBvhcC0AMQBaAGBEAYQA1gUBKgDQCWgHBqBTQBsBUBJByQAeAuAhBKIinAVg");
            this.shape_24.setTransform(-11.85,10.4608);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_24},{t:this.shape_23}]}).wait(130));
        
            this._renderFirstFrame();
        
        }).prototype = p = new cjs.MovieClip();
        p.nominalBounds = new cjs.Rectangle(-145.4,-218.1,216.3,313);
        
        
        // stage content:
        (lib.rabbit3 = function(mode,startPosition,loop,reversed) {
        if (loop == null) { loop = true; }
        if (reversed == null) { reversed = false; }
            var props = new Object();
            props.mode = mode;
            ...
            this.instance.setTransform(174.35,338.95,0.7691,0.7691,0,0,0,-46.1,-60.4);
        
            this.timeline.addTween(cjs.Tween.get(this.instance).wait(130));
        
            // 影子
            this.instance_1 = new lib.补间6("synched",0);
            this.instance_1.setTransform(200,446.4,1,1.9231);
        ...
        p.nominalBounds = new cjs.Rectangle(306,469.3,-46.5,-10.300000000000011);
        // library properties:
        lib.properties = {
