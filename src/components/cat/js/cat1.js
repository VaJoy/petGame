...
(function (cjs, an) {
    ...
    (lib.补间7 = function(mode,startPosition,loop,reversed) {
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_1
            this.shape = new cjs.Shape();
            this.shape.graphics.f("#F49A7A").s().p("");
            this.shape.setTransform(31.1915,22.1241,0.9171,0.9171);
        
            this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
        
            // 图层_1
            this.shape_1 = new cjs.Shape();
            this.shape_1.graphics.f("#FFFFFF").s().p("");
            this.shape_1.setTransform(31.1915,22.1207,0.9171,0.9171);
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_4
            this.shape = new cjs.Shape();
            this.shape.graphics.f().s("#4F8C69").ss(3,1,1).p("AKLBDQAAC7ghB4QgkCEhcB6QhZB2iIA4Qh1AwiUAAQiTAAh1gwQiIg4hZh2Qhch6gkiEQghh4AAi7QAAixA1ilQA0ilBgh/QBmiHBnhFQB1hOB/AAQCAAAB1BOQBnBFBmCHQBgB/A0ClQA1ClAACxg");
            ...
            this.shape_2.graphics.f("#B0E5CB").s().p("AnaKRQhch6gkiDQghh4AAi7QAAixA1ilQA0ilBgh/QBmiHBnhFQB1hOB/AAQCAAAB0BOQBoBFBmCHQBfB/A1ClQANAqAKAsQgKgqgNgpQgXhHgeg/QgphVg2hJQhBhWhCg7QA/CGAqCqQByHKjEE8QjLFHjqBFQhRAYhyABQh3g4hQhrg");
            this.shape_2.setTransform(56.0375,-37.025);
        
            this.shape_3 = new cjs.Shape();
            this.shape_3.graphics.f("#71C99C").s().p("Am5LdIgggOIAGAAQBzgCBRgXQDqhFDKlHQDEk8hxnKQgriqg+iGQBBA6BBBXQA2BJApBUQAfBAAWBGQANAqAKApIAeECIAAADIgSDvQgHAjgIAgQgYBXgxBUQgYApgfApQhZB3iIA3Qh1AxiTgBQiTABh2gxg");
            this.shape_3.setTransform(75.2,-26.9);
