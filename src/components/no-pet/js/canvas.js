...
(function (cjs, an) {
    ...
    (lib.蛋 = function(mode,startPosition,loop,reversed) {
        ...
        if (reversed == null) { reversed = false; }
            ...
            this.shape.graphics.f().s("#999999").ss(3,1,1).p("AKLBDQAAC7ghB4QgkCEhcB6QhZB2iIA4Qh1AwiUAAQiTAAh1gwQiIg4hZh2Qhch6gkiEQghh4AAi7QAAixA1ilQA0ilBgh/QBmiHBnhFQB1hOB/AAQCAAAB1BOQBnBFBmCHQBgB/A0ClQA1ClAACxg");
            ...
            this.shape_2.graphics.f("#DFDFDF").s().p("AnaKRQhch6gkiDQghh4AAi7QAAixA1ilQA0ilBgh/QBmiHBnhFQB1hOB/AAQCAAAB0BOQBoBFBmCHQBfB/A1ClQANAqAKAsQgKgqgNgpQgXhHgeg/QgphVg2hJQhBhWhCg7QA/CGAqCqQByHKjEE8QjLFHjqBFQhRAYhyABQh3g4hQhrg");
            this.shape_2.setTransform(56.0375,-37.025);
        
            this.shape_3 = new cjs.Shape();
            this.shape_3.graphics.f("#CCCCCC").s().p("Am5LdIgggOIAGAAQBzgCBRgXQDqhFDKlHQDEk8hxnKQgriqg+iGQBBA6BBBXQA2BJApBUQAfBAAWBGQANAqAKApIAeECIAAADIgSDvQgHAjgIAgQgYBXgxBUQgYApgfApQhZB3iIA3Qh1AxiTgBQiTABh2gxg");
        ...
        if (reversed == null) { reversed = false; }
            ...
            this.timeline.addTween(cjs.Tween.get(this.instance).to({y:321.45},59).to({y:331.95},60).wait(1));
            ...
            this.instance_2.setTransform(200,445.4);
        
            this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1}]}).to({state:[{t:this.instance_1}]},59).to({state:[{t:this.instance_2}]},60).wait(1));
            this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:0.8575,scaleY:0.8575},59).to({_off:true,scaleX:1,scaleY:1},60).wait(1));
        
            this._renderFirstFrame();
        
        }).prototype = p = new lib.AnMovieClip();
        p.nominalBounds = new cjs.Rectangle(333.5,484.9,-66.89999999999998,-33);
        // library properties:
        lib.properties = {
