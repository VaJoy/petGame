...
(function (cjs, an) {
    ...
    (lib.补间7 = function(mode,startPosition,loop,reversed) {
        ...
        if (reversed == null) { reversed = false; }
            ...
            // dog_复制
            this.shape = new cjs.Shape();
            this.shape.graphics.f("#F49A7A").s().p("");
        ...
        if (reversed == null) { reversed = false; }
            ...
            // 图层_4
            this.shape = new cjs.Shape();
            this.shape.graphics.f().s("#B36D47").ss(3,1,1).p("AKLBDQAAC7ghB4QgkCEhcB6QhZB2iIA4Qh1AwiUAAQiTAAh1gwQiIg4hZh2Qhch6gkiEQghh4AAi7QAAixA1ilQA0ilBgh/QBmiHBnhFQB1hOB/AAQCAAAB1BOQBnBFBmCHQBgB/A0ClQA1ClAACxg");
            ...
            // 图层_5
            this.shape_2 = new cjs.Shape();
            this.shape_2.graphics.f("#D99660").s().p("Am5LdIgggOIAGAAQBzgCBRgXQDqhFDKlHQDEk8hxnKQgriqg+iGQBBA6BBBXQA2BJApBUQAfBAAWBGQANAqAKApIAeECIAAADIgSDvQgHAjgIAgQgYBXgxBUQgYApgfApQhZB3iIA3Qh1AxiTgBQiTABh2gxg");
            this.shape_2.setTransform(75.2,-26.9);
        
            this.shape_3 = new cjs.Shape();
            this.shape_3.graphics.f("#ECC8A8").s().p("AnaKRQhch6gkiDQghh4AAi7QAAixA1ilQA0ilBgh/QBmiHBnhFQB1hOB/AAQCAAAB0BOQBoBFBmCHQBfB/A1ClQANAqAKAsQgKgqgNgpQgXhHgeg/QgphVg2hJQhBhWhCg7QA/CGAqCqQByHKjEE8QjLFHjqBFQhRAYhyABQh3g4hQhrg");
